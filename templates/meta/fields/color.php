...
// A native color input needs a valid hex; default when unset.
$orbem_studio_final_value = false === empty($orbem_studio_final_value) ? $orbem_studio_final_value : '#00e5ff';
?>
<p>
<label>
...
<input class="top"
       ...
       value="<?php echo esc_attr($orbem_studio_final_value); ?>"
