...
<div class="characters-form">
    ...
    <div class="character-list">
        ...
        foreach( $characters as $character ) :
            ...
            $character_weapon = get_the_terms($character_post[0]->ID, 'explore-weapon-choice');
        ...
        ?>
            <div class="character-item" data-ability="<?php echo esc_attr( $character_ability ); ?>" data-charactername="<?php echo esc_attr( $character_post[0]->post_name ); ?>" data-weapon="<?php echo false === empty($character_weapon[0]) ? esc_attr($character_weapon[0]->slug) : ''; ?>">
