...
$orbem_studio_explore_missions        = is_array($orbem_studio_explore_missions) ? $orbem_studio_explore_missions : [];
$orbem_studio_completed_missions      = get_user_meta($orbem_studio_userid, 'explore_missions', true);
$orbem_studio_completed_missions      = false === empty($orbem_studio_completed_missions) && true === is_array($orbem_studio_completed_missions) ? $orbem_studio_completed_missions : [];
...
$orbem_studio_linked_mission          = [];
$orbem_studio_missions_from_cutscenes = [];
    ...
    foreach($orbem_studio_explore_missions as $orbem_studio_mission) :
        ...
        if (false === in_array($orbem_studio_mission->post_name, $orbem_studio_completed_missions, true)) :
            ...
            <div
                ...
                data-nextmission="<?php echo esc_attr(implode(',', (is_array($orbem_studio_next_mission) ? array_keys($orbem_studio_next_mission) : [$orbem_studio_next_mission]))); ?>"
