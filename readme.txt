...
* Auto-equip a collected weapon when the storage weapons tab is disabled or storage is hidden, dropping any currently held non-default weapon back onto the map.
...
* Reorganize devmode buttons.

= 1.5.2 =
* Add gravity option to items.
* Prevent main character from deletion.
* Prevent start area from deletion.
* Fix empty mission issue.
...
= 1.4.14 =
* Add scroll to for explainers.
* Global drag handler for pro plugin.

= 1.4.13 =
* Add more local storage for multilevel.
* Fix console errors for new areas.
...
* Fix radio field label.
* Add default to weapon strength.
* Allow area multifield for all fields.
* Fix mission grab.
* Apply projectile styles to shooters.
* Fix music pause console error.

= 1.4.10 =
* Fix tmp name typo.
* Add memory timeout fix for import.

= 1.4.9 =
* Add area map image size control.
...
= 1.4.6 =
* Fix move npc after cutscene logic.
* Fix remove after cutscene backcompat.
* Fix try-again if multiple.
* Fix score saving logic.
* Optimize background logic.

= 1.4.5 =
* Add sound controls to explainer.
* Update meta fields.
* Fix preview update on img select.
* Update devmode hud.

= 1.4.4 =
* Redesign devmode menu.
* Revert contain layout bug.
* Remove unused pro functions.
