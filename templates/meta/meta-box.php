...
$orbem_studio_meta_data             = is_array( $orbem_studio_meta_data ) ? $orbem_studio_meta_data : array();
 ...
 */
$orbem_studio_allowed_tags['select'] = array(
	'name'     => true,
	'id'       => true,
	'class'    => true,
	'multiple' => true,
...
$orbem_studio_allowed_tags['option'] = array(
	'value'    => true,
	'selected' => true,
	'disabled' => true,
	'label'    => true,
...
<div id="explore-meta-box">
	...
	<?php endif; ?>
	<?php
	foreach ( $orbem_studio_meta_data as $orbem_studio_key => $orbem_studio_value ) :
		...
		?>
		<hr>
		<h2><?php echo esc_html( ucfirst( str_replace( array( 'explore-', '-' ), array( '', ' ' ), $orbem_studio_key ) ) ); ?></h2>
