...
$orbem_studio_allowed_tags['svg'] = array(
	'class'           => true,
	'aria-hidden'     => true,
...
$orbem_studio_allowed_tags['defs'] = array();

$orbem_studio_allowed_tags['style'] = array(
	'type' => true,
);

$orbem_studio_allowed_tags['g'] = array(
	'class'        => true,
	'id'           => true,
	'fill'         => true,
	'stroke'       => true,
...
$orbem_studio_allowed_tags['path'] = array(
	'class'        => true,
	'd'            => true,
	'fill'         => true,
	'stroke'       => true,
...
$orbem_studio_allowed_tags['ellipse'] = array(
	'class'        => true,
	'cx'           => true,
	'cy'           => true,
	'rx'           => true,
...
$orbem_studio_allowed_tags['circle'] = array(
	'class'        => true,
	'cx'           => true,
	'cy'           => true,
	'r'            => true,
...
$orbem_studio_allowed_tags['rect'] = array(
	'class'        => true,
	'x'            => true,
	'y'            => true,
	'width'        => true,
...
$orbem_studio_allowed_tags['line'] = array(
	'x1'           => true,
	'y1'           => true,
	'x2'           => true,
	'y2'           => true,
...
$orbem_studio_allowed_tags['polygon'] = array(
	'points'       => true,
	'fill'         => true,
	'stroke'       => true,
	'stroke-width' => true,
...
$orbem_studio_allowed_tags['polyline'] = array(
	'points'       => true,
	'fill'         => true,
	'stroke'       => true,
	'stroke-width' => true,
...
$orbem_studio_allowed_tags['title']            = array();
$orbem_studio_allowed_tags['desc']             = array();
...
$orbem_studio_hud_bars                     = get_option( 'explore_hud_bars', array() );
...
$orbem_studio_explore_area                 = get_posts(
	array(
		'post_type' => 'explore-area',
		'name'      => $orbem_studio_location,
	)
);
...
$orbem_studio_direction_images             = $orbem_studio_main_character_info['direction_images'] ?? array();
...
require plugin_dir_path( __FILE__ ) . 'plugin-header.php';
?>
<main id="primary"<?php echo esc_attr( true === $orbem_studio_is_admin ? ' data-devmode=true' : '' ); ?> class="site-main<?php echo esc_attr( $orbem_studio_rst ); ?>">
	<?php require $orbem_studio_plugin_dir_path . 'start-screen.php'; ?>
		...
		<div id="explore-points">
			...
			<div id="missions">
				<div class="missions-content">
					<?php require $orbem_studio_plugin_dir_path . '/components/explore-missions.php'; ?>
				</div>
			</div>
		</div>
		<div id="settings">
			<div class="setting-content">
				<?php require $orbem_studio_plugin_dir_path . '/components/explore-settings.php'; ?>
			</div>
		</div>
		<div id="characters" style="display: none;">
			<div class="characters-content">
				<?php require $orbem_studio_plugin_dir_path . '/components/explore-characters.php'; ?>
			</div>
		</div>
		...
		>
			...
			foreach ( $orbem_studio_direction_images as $orbem_studio_direction_label => $orbem_studio_direction_image ) :
				...
				<img
					...
					class="map-character-icon
					<?php
					echo esc_attr( $orbem_studio_direction_label === $orbem_studio_dir_image ? ' engage' : '' );
					echo esc_attr( $orbem_studio_fight_animation );
					?>
					"
...
<?php
require plugin_dir_path( __FILE__ ) . '/plugin-footer.php';
