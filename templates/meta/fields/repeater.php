...
$orbem_studio_final_value           = false === empty($orbem_studio_meta_values[$orbem_studio_key]) ? $orbem_studio_meta_values[$orbem_studio_key] : [1];
$orbem_studio_sub_value             = true === is_array($orbem_studio_sub_value) ? $orbem_studio_sub_value : [];
...
<label>
    <div class="field-container-wrap">
        ...
        <?php $orbem_studio_repeat_index++; endfor; ?>
    </div>
