...
foreach($orbem_studio_explore_points as $orbem_studio_explore_point):
    ...
    $orbem_studio_background_url = true === in_array($orbem_studio_explore_point->post_type, ['explore-weapon', 'explore-point', 'explore-character', 'explore-enemy'], true) ? "background: url(" . esc_url($orbem_studio_map_url) . ") no-repeat;" : '';
