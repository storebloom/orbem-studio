...
class Plugin extends Plugin_Base {
	...
	public function __construct() {
		...
		register_activation_hook(
			...
			array( $this, 'activateOrbemStudio' )
		);
	}
	...
	public static function enqueueScript(
		...
		$localizes[] = array(
			...
			'value'       => array(
				...
				'wpThemeURL'           => str_replace( array( 'https://', 'http://', 'www' ), '', get_home_url() ),
	...
	public function addFilterToTaxo(): void {
		...
		if ( ! str_starts_with( $typenow, 'explore-' ) ) {
			return;
		}
	...
	public function blockGutenbergBlocks( bool|array $allowed_blocks, \WP_Block_Editor_Context $editor_context ): bool|array {
		...
		if ( in_array( $post_type, array( 'explore-magic', 'explore-explainer', 'explore-sign' ), true ) ) {
			return array(
				'core/paragraph',
				'core/image',
			);
		...
		if ( in_array( $post_type, array( 'explore-cutscene', 'explore-communicate' ), true ) ) {
			return array(
				'orbem/paragraph-mp3',
				'core/video',
			);
